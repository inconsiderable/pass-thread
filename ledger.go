...
type Ledger interface {
	...
	// ConnectPass connects a pass to the tip of the pass thread and applies the considerations
	// to the ledger.
	ConnectPass(id PassID, pass *Pass) ([]ConsiderationID, error)

	// DisconnectPass disconnects a pass from the tip of the pass thread and undoes the effects
