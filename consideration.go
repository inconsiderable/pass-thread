...
type Consideration struct {//TODO: Beware of reordering struct fields, IDs seem to be sensitive to field order.
	...
	Matures   int64             `json:"matures,omitempty"` // pass height. if set consideration can't be weaved before
	Expires   int64             `json:"expires,omitempty"` // pass height. if set consideration can't be weaved after
...
// used to recognise the weaver for weaving the pass.
...
// IsMature returns true if the consideration can be weaved at the given height.
...
// IsExpired returns true if the consideration cannot be weaved at the given height.
