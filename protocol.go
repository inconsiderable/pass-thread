...
// Protocol is the name of this version of the passthread peer protocol.
const Protocol = "passthread.1"

// Message is a message frame for all messages in the passthread.1 protocol.
type Message struct {
...
// TipHeaderMessage is used to send a peer the header for the tip pass in the pass thread.
...
// height range of the pass thread.
...
// the public key over a given height range of the pass thread.
...
// GetWorkMessage is used by a weaving peer to request weaving work.
// Type: "get_work"
...
// WorkMessage is used by a client to send work to perform to a weaving peer.
// The timestamp and nonce in the header can be manipulated by the weaving peer.
// It is the weaving peer's responsibility to ensure the timestamp is not set below
...
// SubmitWorkMessage is used by a weaving peer to submit a potential solution to the client.
// Type: "submit_work"
...
// SubmitWorkResultMessage is used to inform a weaving peer of the result of its work.
